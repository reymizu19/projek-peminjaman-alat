                ...
                <tbody class="text-gray-700 text-sm">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="py-3 px-4 border-b">
                            @if($alat->gambar)
                                <img src="{{ Storage::disk('public')->url($alat->gambar) }}" alt="{{ $alat->nama_alat }}" class="w-12 h-12 object-cover rounded-lg border">
                            @else
                        ...
                        <td class="py-3 px-4 border-b">
                            <div class="flex items-center space-x-2">
                                ...
                                <form action="{{ route('admin.alat.destroy', $alat->id) }}"
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="bg-red-500 hover:bg-red-600 text-white px-3 py-1.5 rounded-xs text-xs font-semibold transition">
                                        Hapus
                                    </button>
                                </form>
                            </div>
